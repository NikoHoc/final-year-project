              ...
              {unsavedItems.map((item) => (
                <div key={item.unique_id} className="p-3 space-y-2">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <button onClick={() => onRemove(item.unique_id)} className="cursor-pointer text-red-500 hover:text-white hover:bg-red-500 p-2 bg-white border border-red-50 rounded-lg transition-colors">
                      <Trash2 size={14} />
                    </button>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {item.menu.half_price && (
                      <button 
                        ...
                        className={`cursor-pointer text-[9px] px-2 py-2 rounded-lg font-bold whitespace-nowrap transition-colors ${item.is_half_portion ? "bg-blue-600 text-white" : "bg-white border border-blue-100 text-gray-400"}`}
                      >
                        1/2 PORSI
                      </button>
                    )}
              ...
              {items.map((item) => (
                <div key={item.id} className="p-3 flex justify-between items-start">
                  <div className="space-y-0.5">
                    ...
                    {item.note && <p className="text-[10px] font-semibold text-orange-400 italic"># {item.note}</p>}
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`cursor-pointer p-1.5 rounded-lg transition-colors ${item.serve_status === 'served' ? 'text-gray-200 cursor-not-allowed' : 'text-gray-400 hover:bg-gray-100 hover:text-blue-600'}`}
                    >
                      <Settings size={14} />
                    </button>
                  </div>
