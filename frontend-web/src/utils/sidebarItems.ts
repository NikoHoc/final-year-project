...
export const SIDEBAR_ITEMS: Record<Role, SidebarItem[]> = {
  admin: [
    ...
    { title: "Master Menu", path: "/admin/menus", icon: UtensilsCrossed },
  ...
  kasir: [
    { title: "Dashboard", path: "/kasir", icon: LayoutDashboard },
    { title: "Transaksi Online", path: "/kasir/online", icon: Receipt },
    { title: "Meja", path: "/kasir/tables", icon: TableCellsMerge},
    { title: "Master Menu", path: "/kasir/menus", icon: UtensilsCrossed},
  ...
  pelayan: [
    { title: "Dashboard", path: "/pelayan", icon: LayoutDashboard },
  ],
  pelanggan: [],
};
